...
import { ShoppingCart, Star, ArrowLeft, Skull, Check, X, Info } from "lucide-react"
...
const skullMasks: SkullMask[] = [
  {
    ...
    description: "Realistic golden skull mask with metallic finish",
  },
  {
    id: "sk-02",
    name: "Bronze Skull Classic",
    code: "SK-02",
    price: 500,
    image: "/images/skull-mask/bronze-skull.jpg",
    description: "Bronze skull mask with detailed copper finish",
  },
  {
    id: "sk-03",
    name: "Silver Skull Metallic",
    code: "SK-03",
    price: 500,
    image: "/images/skull-mask/silver-skull.jpg",
    description: "Silver metallic skull mask with realistic features",
  },
  {
    id: "sk-04",
    name: "Green Monster Skull",
    code: "SK-04",
    price: 500,
    image: "/images/skull-mask/green-monster-skull.jpg",
    description: "Green monster skull with fangs and grotesque design",
  },
  {
    id: "sk-05",
    name: "Red Skull Gothic",
    code: "SK-05",
    price: 500,
    image: "/images/skull-mask/red-skull.jpg",
    description: "Dark red gothic skull mask with realistic details",
  },
  {
    id: "sk-06",
    name: "Gray Monster Skull",
    code: "SK-06",
    price: 500,
    image: "/images/skull-mask/gray-monster-skull.jpg",
    description: "Gray monster skull with fangs and weathered finish",
  },
  {
    id: "sk-07",
    name: "Black Wolf Skull",
    code: "SK-07",
    price: 500,
    image: "/images/skull-mask/black-wolf-skull.jpg",
    description: "Black wolf skull mask with pointed ears and fangs",
  },
  {
    id: "sk-08",
    name: "White Wolf Skull",
    code: "SK-08",
    price: 500,
    image: "/images/skull-mask/white-wolf-skull.jpg",
    description: "White wolf skull mask with fangs and detailed bone structure",
  },
  {
    id: "sk-09",
    name: "Golden Zombie Mask",
    code: "SK-09",
    price: 500,
    image: "/images/skull-mask/golden-zombie-mask.jpg",
    description: "Detailed golden zombie mask with horrific features and visible teeth",
  },
]

export default function SkullMaskPage() {
  ...
  const orderViaWhatsApp = (mask: SkullMask) => {
  ...
  const orderSelectedMasks = () => {
    ...
    const selectedMasksList = skullMasks.filter((mask) => selectedMasks.has(mask.id))
    ...
    const message = `Hi! I'd like to order the following Skull masks:\n\n${itemsList}\n\nTotal: KSH ${totalPrice}\n\nPlease confirm availability and delivery details.`
    const encodedMessage = encodeURIComponent(message)
    window.open(`https://wa.me/${whatsappNumber}?text=${encodedMessage}`, "_blank")
  }
  ...
  const totalPrice = skullMasks.filter((mask) => selectedMasks.has(mask.id)).reduce((sum, mask) => sum + mask.price, 0)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-black relative overflow-hidden">
      ...
      {showGuide && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <Button
              className="w-full bg-gradient-to-r from-red-600 to-gray-600 hover:from-red-700 hover:to-gray-700 text-white font-medium py-3 rounded-xl shadow-lg"
              onClick={() => setShowGuide(false)}
            >
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-20 w-32 h-32 md:w-72 md:h-72 bg-red-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-32 h-32 md:w-72 md:h-72 bg-gray-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
      ...
      <header className="relative z-10 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white bg-gradient-to-r from-gray-400 via-red-500 to-black bg-clip-text text-transparent mb-2">
              SKULL MASKS
            </h1>
            <p className="text-white/80 text-sm md:text-lg">Gothic Collection</p>
          </div>
        </div>
      </header>
      ...
      {selectedCount > 0 && (
        <div className="fixed top-24 left-0 right-0 z-40 px-4">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
            <div className="backdrop-blur-md bg-gradient-to-r from-red-600/90 to-gray-600/90 rounded-2xl p-4 border border-white/20 shadow-xl">
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    className="bg-white text-red-600 hover:bg-gray-100 font-medium rounded-full px-6"
          ...
          <div className="text-center mb-8">
            <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-gray-400">{skullMasks.length}</div>
                  <div className="text-white/70 text-xs md:text-sm">Skull Designs</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-yellow-400">Gothic</div>
                ...
                >
                  ...
                  >
                    <div className="relative">
                      <div className="aspect-square bg-gradient-to-br from-gray-500/20 to-red-500/20 flex items-center justify-center relative overflow-hidden">
                        <img
      ...
      <footer className="relative z-10 py-12 px-4 border-t border-white/20 mt-20">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-bold text-white mb-4">SKULL MASK COLLECTION</h3>
          <p className="text-white/70 mb-6">Gothic skull masks for dramatic occasions</p>
          <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
