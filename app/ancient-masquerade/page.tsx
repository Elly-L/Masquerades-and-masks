...
import { ShoppingCart, Star, ArrowLeft, Crown, Check, X, Info } from "lucide-react"
...
const ancientMasks: AncientMask[] = [
  {
    id: "am-01",
    name: "Ornate Silver Venetian",
    code: "AM-01",
    price: 500,
    image: "/images/ancient-masquerade/ornate-silver.jpg",
    description: "Intricate silver Venetian mask with detailed engravings",
  },
  {
    id: "am-02",
    name: "Golden Ornate Classic",
    code: "AM-02",
    price: 500,
    image: "/images/ancient-masquerade/golden-ornate.jpg",
    description: "Luxurious golden mask with ornate patterns and decorative elements",
  },
  {
    id: "am-03",
    name: "Black Textured Vintage",
    code: "AM-03",
    price: 500,
    image: "/images/ancient-masquerade/black-textured.jpg",
    description: "Weathered black mask with vintage textured finish",
  },
  {
    id: "am-04",
    name: "Silver Swirl Pattern",
    code: "AM-04",
    price: 500,
    image: "/images/ancient-masquerade/silver-swirl.jpg",
    description: "Elegant silver mask with swirling decorative patterns",
  },
  {
    id: "am-05",
    name: "Golden Swirl Classic",
    code: "AM-05",
    price: 500,
    image: "/images/ancient-masquerade/golden-swirl.jpg",
    description: "Classic golden mask with intricate swirl designs",
  },
  {
    id: "am-06",
    name: "Bronze Textured Royal",
    code: "AM-06",
    price: 500,
    image: "/images/ancient-masquerade/bronze-textured.jpg",
    description: "Royal bronze mask with textured surface and crown element",
  },
]

export default function AncientMasqueradePage() {
  ...
  const orderViaWhatsApp = (mask: AncientMask) => {
  ...
  const orderSelectedMasks = () => {
    ...
    const selectedMasksList = ancientMasks.filter((mask) => selectedMasks.has(mask.id))
    ...
    const message = `Hi! I'd like to order the following Ancient Masquerade masks:\n\n${itemsList}\n\nTotal: KSH ${totalPrice}\n\nPlease confirm availability and delivery details.`
    const encodedMessage = encodeURIComponent(message)
    window.open(`https://wa.me/${whatsappNumber}?text=${encodedMessage}`, "_blank")
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-900 via-orange-900 to-red-900 relative overflow-hidden">
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-4 p-3 bg-yellow-50 rounded-xl">
                <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-0.5">
                  1
                </div>
                <div>
              ...
              <div className="flex items-start gap-4 p-3 bg-orange-50 rounded-xl">
                <div className="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-0.5">
                  2
                </div>
                <div>
              ...
              <div className="flex items-start gap-4 p-3 bg-red-50 rounded-xl">
                <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0 mt-0.5">
                  3
                </div>
                <div>
            ...
            <Button
              className="w-full bg-gradient-to-r from-yellow-600 to-red-600 hover:from-yellow-700 hover:to-red-700 text-white font-medium py-3 rounded-xl shadow-lg"
              onClick={() => setShowGuide(false)}
            >
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-20 w-32 h-32 md:w-72 md:h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-32 h-32 md:w-72 md:h-72 bg-orange-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-40 w-32 h-32 md:w-72 md:h-72 bg-red-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-2000"></div>
      </div>
      ...
      <header className="relative z-10 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white bg-gradient-to-r from-yellow-400 via-orange-500 to-red-600 bg-clip-text text-transparent mb-2">
              ANCIENT MASQUERADE
            </h1>
            <p className="text-white/80 text-sm md:text-lg">Vintage Collection</p>
          </div>
        </div>
      </header>
      ...
      {selectedCount > 0 && (
        <div className="fixed top-16 left-0 right-0 z-40 px-4">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
            <div className="backdrop-blur-md bg-gradient-to-r from-yellow-600/90 to-red-600/90 rounded-2xl p-4 border border-white/20 shadow-xl">
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    className="bg-white text-yellow-600 hover:bg-gray-100 font-medium rounded-full px-6"
          ...
          <div className="text-center mb-8">
            <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-yellow-400">{ancientMasks.length}</div>
                  <div className="text-white/70 text-xs md:text-sm">Ancient Designs</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-orange-400">KSH 500</div>
                  <div className="text-white/70 text-xs md:text-sm">Each Mask</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-red-400">Vintage</div>
                ...
                >
                  ...
                  >
                    <div className="relative">
                      <div className="aspect-square bg-gradient-to-br from-yellow-500/20 to-orange-500/20 flex items-center justify-center relative overflow-hidden">
                        <img
                        ...
                        <Badge className="absolute top-3 right-3 bg-yellow-600 text-white border-0">
      ...
      <footer className="relative z-10 py-12 px-4 border-t border-white/20 mt-20">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-bold text-white mb-4">ANCIENT MASQUERADE COLLECTION</h3>
          <p className="text-white/70 mb-6">Timeless vintage masks with historical elegance</p>
          <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
