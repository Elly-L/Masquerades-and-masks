...
const unisexMasks: UnisexMask[] = [
  {
    id: "mw-01",
    name: "Black & White Swirl",
    code: "MW-01",
    price: 500,
    image: "/images/men-women/black-white-swirl.jpg",
    description: "Elegant black and white contrasting mask with swirl patterns",
  },
  {
    id: "mw-02",
    name: "Silver Floral Design",
    code: "MW-02",
    price: 500,
    image: "/images/men-women/silver-floral.jpg",
    description: "Sophisticated silver mask with floral patterns and swirl designs",
  },
  {
    id: "mw-03",
    ...
    code: "MW-03",
    price: 500,
    image: "/images/men-women/black-gold-floral.jpg",
    description: "Luxurious black and gold mask with intricate floral patterns",
  },
  {
    id: "mw-04",
    name: "Silver Metallic Classic",
    code: "MW-04",
    price: 500,
    image: "/images/men-women/silver-metallic.jpg",
    description: "Classic silver metallic mask with floral patterns and elegant swirls",
  },
]

export default function MenWomenPage() {
  ...
  const orderViaWhatsApp = (mask: UnisexMask) => {
  ...
  const orderSelectedMasks = () => {
    ...
    const selectedMasksList = unisexMasks.filter((mask) => selectedMasks.has(mask.id))
    ...
    const message = `Hi! I'd like to order the following Men/Women masks:\n\n${itemsList}\n\nTotal: KSH ${totalPrice}\n\nPlease confirm availability and delivery details.`
    const encodedMessage = encodeURIComponent(message)
    window.open(`https://wa.me/${whatsappNumber}?text=${encodedMessage}`, "_blank")
  }
  ...
  const totalPrice = unisexMasks.filter((mask) => selectedMasks.has(mask.id)).reduce((sum, mask) => sum + mask.price, 0)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900 relative overflow-hidden">
      ...
      {showGuide && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <Button
              className="w-full bg-gradient-to-r from-blue-600 to-pink-600 hover:from-blue-700 hover:to-pink-700 text-white font-medium py-3 rounded-xl shadow-lg"
              onClick={() => setShowGuide(false)}
            >
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-20 w-32 h-32 md:w-72 md:h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
      ...
      <header className="relative z-10 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white bg-gradient-to-r from-blue-400 via-purple-500 to-pink-600 bg-clip-text text-transparent mb-2">
              MEN/WOMEN
            </h1>
            <p className="text-white/80 text-sm md:text-lg">Unisex Collection</p>
          </div>
        </div>
      </header>
      ...
      {selectedCount > 0 && (
        <div className="fixed top-16 left-0 right-0 z-40 px-4">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
            <div className="backdrop-blur-md bg-gradient-to-r from-blue-600/90 to-pink-600/90 rounded-2xl p-4 border border-white/20 shadow-xl">
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    className="bg-white text-blue-600 hover:bg-gray-100 font-medium rounded-full px-6"
          ...
          <div className="text-center mb-8">
            <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-blue-400">{unisexMasks.length}</div>
                  <div className="text-white/70 text-xs md:text-sm">Unisex Designs</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-pink-400">Universal</div>
                ...
                >
                  ...
                  >
                    <div className="relative">
                      <div className="aspect-square bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center relative overflow-hidden">
                        <img
      ...
      <footer className="relative z-10 py-12 px-4 border-t border-white/20 mt-20">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-bold text-white mb-4">MEN/WOMEN COLLECTION</h3>
          <p className="text-white/70 mb-6">Universal masks perfect for everyone</p>
          <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
