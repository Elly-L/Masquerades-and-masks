...
const phoenixMasks: PhoenixMask[] = [
  {
    id: "pm-01",
    name: "Golden Crown Phoenix",
    code: "PM-01",
    price: 500,
    image: "/images/phoenix-men/golden-crown.jpg",
    description: "Majestic golden phoenix mask with crown spikes and ornate details",
  },
  {
    id: "pm-02",
    name: "Golden Swirl Phoenix",
    code: "PM-02",
    price: 500,
    image: "/images/phoenix-men/golden-swirl.jpg",
    description: "Elegant golden phoenix with swirling patterns and metallic finish",
  },
  {
    id: "pm-03",
    name: "Silver Crown Phoenix",
    code: "PM-03",
    price: 500,
    image: "/images/phoenix-men/silver-crown.jpg",
    description: "Distinguished silver phoenix mask with crown design",
  },
  {
    id: "pm-04",
    name: "Purple Crown Phoenix",
    code: "PM-04",
    price: 500,
    image: "/images/phoenix-men/purple-crown.jpg",
    description: "Royal purple phoenix mask with metallic crown spikes",
  },
]

export default function PhoenixMenPage() {
  ...
  const orderViaWhatsApp = (mask: PhoenixMask) => {
  ...
  const orderSelectedMasks = () => {
    ...
    const selectedMasksList = phoenixMasks.filter((mask) => selectedMasks.has(mask.id))
    ...
    const message = `Hi! I'd like to order the following Phoenix Men masks:\n\n${itemsList}\n\nTotal: KSH ${totalPrice}\n\nPlease confirm availability and delivery details.`
    const encodedMessage = encodeURIComponent(message)
    window.open(`https://wa.me/${whatsappNumber}?text=${encodedMessage}`, "_blank")
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-900 via-orange-900 to-red-900 relative overflow-hidden">
      ...
      <header className="relative z-10 p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-white/80 text-sm md:text-lg">Majestic Collection</p>
          </div>
        </div>
      </header>
          ...
          <div className="text-center mb-8">
            <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
              <div className="grid grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-yellow-400">{phoenixMasks.length}</div>
                  <div className="text-white/70 text-xs md:text-sm">Phoenix Designs</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-red-400">Majestic</div>
      ...
      <footer className="relative z-10 py-12 px-4 border-t border-white/20 mt-20">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-bold text-white mb-4">PHOENIX MEN COLLECTION</h3>
          <p className="text-white/70 mb-6">Majestic masks for distinguished gentlemen</p>
          <div className="backdrop-blur-md bg-white/10 rounded-2xl p-6 border border-white/20 inline-block">
